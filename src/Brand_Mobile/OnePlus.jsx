...
const OnePlus = () => {
  ...
  const loadData = () => {
    let api = `http://localhost:3000/products/?brand=OnePlus`;
        ...
        <Container>
          ...
          >
            ...
            <div id="box2">
              ...
              <span style={{padding:'1px 10px 0px 0px',fontWeight:'bold',fontSize:'14px',color:'black'}}>3.6</span> 
              ...
              <span style={{padding:'1px 0px 0px 10px',fontSize:'14px',color:'black',textTransform:'lowercase',color:'#183961'}}>1,154 ratings</span>
              </div>
