...
const IPhone = () => {
  ...
  const loadData = () => {
    let api = `http://localhost:3000/products/?brand=Apple`;
        ...
        <Container>
          ...
          >
            ...
            <div id="box2">
              ...
              <span style={{padding:'1px 0px 0px 10px',fontSize:'14px',color:'black',textTransform:'lowercase',color:'#183961'}}>1,271 ratings</span>
              </div>
