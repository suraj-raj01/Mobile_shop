...
const Zebronics_keyboards = () => {
  ...
  const loadData = () => {
    let api = `http://localhost:3000/products/?brand=zebronics_key`;
        ...
        <Container>
          ...
          >
            ...
            <div id="box2">
              ...
              <span style={{padding:'1px 10px 0px 0px',fontWeight:'bold',fontSize:'14px',color:'black'}}>3.4</span> 
...
export default Zebronics_keyboards;
