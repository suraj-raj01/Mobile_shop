...
const AcerTv = () => {
  ...
  const loadData = () => {
    let api = `http://localhost:3000/products/?brand=Acertv`;
        ...
        <Container>
          ...
          >
            ...
            <div id="box2">
              ...
              <span>Resolution : {key.resolution}</span>
              <br />
              <span>Brand : {key.brand}</span>
              <br />
              <span>Screen-Size : {key.screen_size}</span>
              <br />
              <span>Display : {key.display}</span>
              <br />
              <span>
                Price : {key.price}
                {" ₹"}
